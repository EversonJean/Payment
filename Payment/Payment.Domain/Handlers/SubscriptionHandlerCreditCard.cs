...
{
    public class SubscriptionHandlerCreditCard : Notifiable, IHandler<CreateCreditCardSubscriptionCommand>
    {
        private readonly IStudentRepository _studentRepository;
        private readonly IEmailService _emailService;

        public SubscriptionHandlerCreditCard(IStudentRepository studentRepository, IEmailService emailService)
        {
