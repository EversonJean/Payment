...
{
    public class SubscriptionHandlerPayPal : Notifiable, IHandler<CreatePayPalSubscriptionCommand>
    {
        private readonly IStudentRepository _studentRepository;
        private readonly IEmailService _emailService;

        public SubscriptionHandlerPayPal(IStudentRepository studentRepository, IEmailService emailService)
        {
